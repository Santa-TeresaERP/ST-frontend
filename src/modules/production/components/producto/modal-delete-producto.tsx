    ...
    <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50 transition-opacity duration-300">
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-lg w-full">
        ...
        <div className="flex justify-center space-x-8">
          <button
            onClick={onConfirm}
            className="bg-red-600 text-white px-8 py-3 rounded-lg shadow-md hover:bg-red-700 hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2"
          >
            <Trash2 size={20} />
            <span>Eliminar</span>
          </button>
