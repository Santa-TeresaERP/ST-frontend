...
const ProductosView = () => {
  ...
  return (
    <div className="p-6 md:p-8">
          ...
          >
            ...
            <div className="p-5">
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 line-clamp-1">{producto.name}</h3>
                  <p className="mt-1 text-sm text-gray-500 line-clamp-2">{producto.description}</p>
                </div>
      ...
      {/* Modales (funcionalidad se mantiene igual) */}
      <ModalCreateProducto isOpen={isCreateModalOpen} onClose={() => setIsCreateModalOpen(false)} />
      <ModalEditProducto
