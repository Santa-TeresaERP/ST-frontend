  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-8">
      ...
      <ModalCreateReserva
        ...
        onSubmit={handleCreateReservaSubmit as any}
      />
      ...
      <ModalEditReserva
        ...
        onSubmit={handleEditReservaSubmit as any}
        reservaToEdit={selectedReserva as any}
      />
      ...
      <ModalDeleteReserva
        ...
        reservaData={selectedReserva as any}
      />
    </div>
  );
};
