...
const ChurchComponentView = () => {
  ...
  // Renderizar contenido de Donativos
  return (
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div className="divide-y divide-gray-200">
                  {filteredDonativos.map((donativo, index) => (
                    ...
                    >
                      <div className="text-gray-800 font-medium text-center">{donativo.nombre}</div>
                      <div className="text-gray-800 font-medium text-center">S/. {donativo.precio.toFixed(2)}</div>
                      <div className="text-gray-700 text-center">{donativo.tipo}</div>
                      <div className="text-gray-700 text-center">{new Date(donativo.fecha).toLocaleDateString('es-PE')}</div>
                      <div className="text-gray-600 text-sm text-center">{donativo.descripcion || '-'}</div>
