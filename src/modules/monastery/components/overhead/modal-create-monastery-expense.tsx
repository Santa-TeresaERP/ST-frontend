...
const ModalCreateMonasteryExpense: React.FC<Props> = ({ isOpen, onClose }) => {
  ...
  // 5. WATCH para valores en tiempo real
        ...
        <div className="bg-gradient-to-r from-red-500 to-red-700 px-6 py-4 rounded-t-2xl">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-xl font-bold text-white">Registrar Nuevo Gasto</h3>
                <p className="text-red-100 text-sm">Agregar un nuevo gasto al monasterio</p>
              </div>
            </div>
            <button 
              onClick={handleClose}
            ...
            <div className="group">
              ...
              <div className="relative">
                <input 
                  ...
                  placeholder="Ej: Compra de víveres, Reparación de techo..."
                />
                {errors.name && (
            ...
            <div className="group">
              ...
              <div className="relative">
                <textarea 
                  ...
                  placeholder="Describa los detalles del gasto, proveedor, motivo, etc..."
                />
              </div>
              {errors.description && (
                <p className="text-red-600 text-sm mt-2 flex items-center">
