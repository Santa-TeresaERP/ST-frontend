...
const MONASTERY_EXPENSES_QUERY_KEY = 'finanzas-monastery-expenses';
...
export const useCreateMonasteryExpense = () => {
  ...
  return useMutation<MonasteryExpense, Error, CreateMonasteryExpensePayload>({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ['finanzas-overheads-monastery'] });
    },
  });
};
...
export const useFinanzasMonasteryExpenses = () => {
