...
interface ModalDeleteLossProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
}

const ModalDeleteLoss: React.FC<ModalDeleteLossProps> = ({ isOpen, onClose, onConfirm }) => {
    ...
    <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50 transition-opacity duration-300">
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-lg w-full">
        ...
        <p className="text-center text-gray-600 mb-8">
          ¿Estás seguro de que deseas eliminar esta pérdida? Esta acción no se puede deshacer.
        </p>
...
export default ModalDeleteLoss;
